...
if __name__ == '__main__':
    ...
    layers = [nfeat_vec, int(nfeat_vec/2), nfeat_vec, 5]
    ...
    # result.select("prediction", "label", "probability").toPandas().to_parquet('./data/results/classification_results.parquet')
